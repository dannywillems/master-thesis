...
La réduction dite \textit{call-by-value} vise à d'abord réduire les arguments,
c'est-à-dire les redex les plus à droites, et ensuite le corps de la fonction.
