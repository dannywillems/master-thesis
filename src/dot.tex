...
% TODO. Toutefois, aucune variante ne semble satisfaisante.
...
$Top <: Bottom$ en utilisant (SEL <:), (<: SEL) et la transitivité. Par
transitivité, nous avons que tous les types sont sous-types l'un de l'autre.

Divers articles sur DOT \cite{OOPSLA-DOT-2016} avancent que restreindre la
